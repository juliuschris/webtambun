              ...
              <div class="row">
                ...
                <div class="col-lg-6">
                  <ol class="sub-list">
                    ...
                    <li>
                      Anda baru-baru ini berkunjung ke suatu negara atau daerah
                      dengan risiko tinggi coronavirus
                    </li>
                    <li>
                      Anda telah melakukan kontak dekat dengan seseorang dengan
                      coronavirus
                    </li>
                  </ol>
                </div>
...
import CegahCovid from "../components/cegahcovid";
